...
import stylescustomer from './customerLogin.module.css';
...
const CustomerRegister = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch(`${url}/api/client/auth`, {
                method: 'POST',
                headers: {
        ...
        <div className={`${stylescustomer.globalcustomer} ${stylescustomer.fadeIn}`}>
            <div className={stylescustomer.cardcustomer}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className={stylescustomer.field}>
                        <svg className={stylescustomer.inputIcon} viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <input onChange={handleValues} id="email" placeholder="Email" className={stylescustomer.inputField} name="email" type="email" />
                    </div>
