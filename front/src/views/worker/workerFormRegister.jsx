...
const WorkerFormRegister = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error('Error en el fecth crear trabajador: ', error);
        }
    };
    ...
    return (
        <div className={styles.global}>
            <div className={styles.card}>
                <h4 className={styles.title}>Regístrate como Trabajador!</h4>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className={styles.field}>
                        ...
                        <input onChange={handleValues} id="cellPhone" placeholder="Phono" className={styles.inputField} name="cellPhone" type="text" />
                    </div>
