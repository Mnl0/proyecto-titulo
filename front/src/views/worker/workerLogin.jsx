...
import styles from './workerLogin.module.css';
...
const WorkerRegister = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch(`${url}/api/worker/auth`, {
                method: 'POST',
                headers: {
    ...
    return (
        <div className={styles.globalworker}>
            <div className={styles.card}>
                <h4 className={styles.title}>Iniciar como Trabajador</h4>
